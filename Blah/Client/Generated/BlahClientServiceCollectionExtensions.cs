...
{
    public static class BlahClientServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddBlahClient(
            this IServiceCollection serviceCollection)
        {
            if (serviceCollection is null)
            {
            ...
            serviceCollection.AddSingleton<IBlahClient, BlahClient>();
        ...
        private static IServiceCollection AddResultParsers(
            this IServiceCollection serviceCollection)
        {
            serviceCollection.AddSingleton<IResultParser, GetProductsResultParser>();
            return serviceCollection;
        }
        ...
        private static Func<HttpClient> ClientFactory(IServiceProvider services)
        {
            ...
            return () => clientFactory.CreateClient("BlahClient");
        }
